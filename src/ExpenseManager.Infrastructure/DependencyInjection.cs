...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IReceiptExpenseLinkService, ReceiptExpenseLinkService>();
        services.AddScoped<IReceiptExpenseLinkReader, ReceiptExpenseLinkReader>();
        services.AddScoped<IReceiptExpenseLinkWriter, ReceiptExpenseLinkWriter>();
