...
public sealed class MainWindowViewModel : CommunityToolkit.Mvvm.ComponentModel.ObservableObject
{
    ...
    public ReceiptsViewModel Receipts { get; }
    ...
    Connections = connections;
        ...
        _navigationMap = new Dictionary<string, NavigationDestination>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Connections"] = new(Translate("NAVIGATION_CONNECTIONS"), Translate("NAVIGATION_CONNECTIONS_SUBTITLE"), connections),
            ["Receipts"] = new(Translate("NAVIGATION_RECEIPTS"), Translate("NAVIGATION_RECEIPTS_SUBTITLE"), receipts),
    ...
    UpdateEntry("Connections", Translate("NAVIGATION_CONNECTIONS"), Translate("NAVIGATION_CONNECTIONS_SUBTITLE"));
    UpdateEntry("Receipts", Translate("NAVIGATION_RECEIPTS"), Translate("NAVIGATION_RECEIPTS_SUBTITLE"));
